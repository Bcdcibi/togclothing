      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="space-y-8 text-lg text-gray-700">
          ...
          <div>
            ...
            <p>Once your order has been dispatched, we will send you an email with tracking information. You can track the status of your delivery on the carrier's website.</p>
          </div>
          ...
          <div>
            ...
            <p>We’ll work to resolve any issues and ensure you have a smooth shopping experience.</p>
          </div>
