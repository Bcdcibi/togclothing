    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="space-y-8 text-lg text-gray-700">
        ...
        <div>
          ...
          <p>We currently offer international shipping with additional charges. Customs duties may apply depending on your country&apos;s regulations.</p> {/* Escape apostrophe */}
        </div>
